...
convert_panel_config: "将面板配置布局从 v3 版本转换到 v4 版本"
convert_old_dir_not_found: "未找到旧版面板目录：{0}"
convert_no_panels_section: "文件中缺少 panels 配置：{0}"
convert_file_failed: "文件转换失败：{0}"
convert_no_old_files: "未找到旧版面板文件。"
convert_success: "面板转换完成：{0} -> {1}"
...
panel_no_items: "面板必须包含至少一个物品。"
panel_invalid_type: "无效的面板类型。"
...
data_missing_key_or_expression: "M缺少键名或表达式。"
...
requirement_source_invalid: "无效的来源，必须为 player 或 panel。"
...
help_convert_description: "将基础布局从 v3 面板转换为 v4 面板（非即插即用）"
dialog_no_buttons: "对话框需要至少一个按钮"
teleport_error: "传送标签出错"
require_headdatabase: "请下载 HeadDatabase 插件以使用此功能！"
```
...
command_unknown_subcommand: "未知的子命令，請使用 /pa help 查看幫助。"
command_subcommand_help: "使用 /pa help 查看子命令列表。"
convert_panel_config: "將面板配置佈局從 v3 版本轉換到 v4 版本"
convert_old_dir_not_found: "找不到舊版面板目錄：{0}"
convert_no_panels_section: "檔案中缺少 panels 配置：{0}"
convert_file_failed: "檔案轉換失敗：{0}"
convert_no_old_files: "找不到舊版面板檔案。"
convert_success: "面板轉換完成：{0} -> {1}"
file_create_panels_fail: "創建面板資料夾失敗！"
file_create_lang_fail: "創建語言檔案失敗！"
file_create_example_fail: "無法創建示例面板！"
file_create_config_fail: "無法創建設定檔案！"
file_update_config_fail: "無法更新設定檔案！"
file_save_data_fail: "無法儲存數據檔案。"
file_save_panel_fail: "無法儲存新面板檔案。"
panel_layout_number_missing: "面板佈局存在編號缺失或跳躍。"
panel_no_items: "面板必須包含至少一件物品。"
panel_invalid_type: "無效的面板類型。"
...
panel_open_player_offline: "玩家離線。"
item_create_fail: "創建物品 {0} 失敗，問題位於：{1}"
item_decoration_fail: "為 {0} 添加物品裝飾失敗，問題位於：{1}"
item_head_load_fail: "頭顱材質標籤：無法載入頭顱：{0}"
item_model_invalid: "無效的物品模型格式，必須為 命名空間:鍵名。"
item_custom_model_invalid: "無效的自訂模型數據，該值不能為空。"
...
data_value: "值：{0}"
data_set: "已將鍵 '{0}' 的值設定為 '{1}'（若不存在則創建）。"
data_overwrite: "已將鍵 '{0}' 的值覆蓋為 '{1}'。"
data_math: "已對鍵 '{1}' 執行數學運算 '{0}'。"
data_delete: "已刪除鍵 '{0}'。"
data_clear: "已清除 '{0}' 的所有數據。"
requirement_unknown_tag: "未知的條件需求標籤。"
requirement_data_invalid: "無效的數據需求。用法：[data] <鍵> <數量>"
requirement_amount_invalid: "無效的數量。"
requirement_data_read_fail: "無法讀取數據。"
...
requirement_source_invalid: "無效的來源，必須為 player 或 panel。"
...
help_reload_command: "/pa reload"
help_reload_description: "重新載入所有配置和面板檔案"
help_generate_command: "/pa generate"
help_generate_description: "進入生成模式以創建面板"
help_data_command: "/pa data"
help_data_description: "修改玩家數據"
help_version_command: "/pa version"
help_version_description: "取得插件版本"
help_help_command: "/pa help"
help_help_description: "顯示此幫助列表"
help_convert_command: "/pa convert"
help_convert_description: "將基礎佈局從 v3 面板轉換為 v4 面板（非即插即用）"
dialog_no_buttons: "對話框需要至少一個按鈕"
teleport_error: "傳送標籤出錯"
require_headdatabase: "請下載 HeadDatabase 插件以使用此功能！"
```
...
convert_panel_config: "將面板配置佈局從 v3 版本轉換到 v4 版本"
convert_old_dir_not_found: "未找到舊版面板目錄：{0}"
convert_no_panels_section: "檔案中缺少 panels 配置：{0}"
convert_file_failed: "檔案轉換失敗：{0}"
convert_no_old_files: "未找到舊版面板檔案。"
convert_success: "面板轉換完成：{0} -> {1}"
file_create_panels_fail: "建立面板資料夾失敗！"
file_create_lang_fail: "建立語言檔案失敗！"
file_create_example_fail: "無法建立範例面板！"
file_create_config_fail: "無法建立設定檔案！"
file_update_config_fail: "無法更新設定檔案！"
file_save_data_fail: "無法儲存資料檔案。"
file_save_panel_fail: "無法儲存新面板檔案。"
panel_layout_number_missing: "面板佈局存在編號缺失或跳躍。"
panel_no_items: "面板必須包含至少一個物品。"
panel_invalid_type: "無效的面板類型。"
panel_not_found: "未找到指定面板。"
panel_open_triggered: "已為玩家開啟面板。"
panel_open_log: "{0} 開啟了 {1}。"
...
item_decoration_fail: "為 {0} 新增物品裝飾失敗，問題位於：{1}"
item_head_load_fail: "頭顱材質標籤：無法載入頭顱：{0}"
item_model_invalid: "無效的物品模型格式，必須為 命名空間:鍵名。"
item_custom_model_invalid: "無效的自訂模型資料，該值不能為空。"
item_give_error: "給予物品時發生錯誤。"
item_grant_syntax_invalid: "語法無效。用法：[grant] 權限 指令"
item_action_syntax_invalid: "無效的物品操作語法。用法: 欄位 操作 [參數]"
item_action_unknown: "未知的物品操作"
item_action_execute_fail: "執行物品操作時發生錯誤。"
item_action_usage_improper: "用法不當。"
...
data_missing_key: "缺少鍵名。"
data_missing_key_or_value: "缺少鍵名或值。"
data_missing_key_or_expression: "缺少鍵名或運算式。"
data_unknown_action: "未知操作。"
data_player_required: "你必須是一名玩家。"
data_value: "值：{0}"
...
sound_play_fail: "播放聲音失敗。"
sound_stop_fail: "停止播放聲音失敗。"
generate_mode_enabled: "產生模式已啟用。"
generate_mode_expired: "產生模式已過期。"
...
help_reload_description: "重新載入所有配置和面板檔案"
help_generate_command: "/pa generate"
help_generate_description: "進入產生模式以建立面板"
help_data_command: "/pa data"
...
help_convert_command: "/pa convert"
help_convert_description: "將基礎佈局從 v3 面板轉換為 v4 面板（非隨插即用）"
dialog_no_buttons: "對話框需要至少一個按鈕"
teleport_error: "傳送標籤出錯"
require_headdatabase: "請下載 HeadDatabase 插件以使用此功能！"
```
